// lesson.16.hw.js.2.kulemichev.19.12.2021
/*
 * #1
 *
...
//  Блок тестирования:
console.log(1, ageClassification(-1) === null); //true
console.log(2, ageClassification(1) === 'детский возраст'); //true
console.log(3, ageClassification(24) === 'детский возраст');//true
console.log(4, ageClassification(24.01) === 'молодой возраст'); //true
console.log(5, ageClassification(44) === 'молодой возраст'); //true
console.log(6, ageClassification(44.01) === 'средний возраст'); //true
console.log(7, ageClassification(65) === 'средний возраст'); //true
console.log(8, ageClassification(65.01) === 'пожилой возраст'); //true
console.log(9, ageClassification(75) === 'пожилой возраст'); //true
console.log(10, ageClassification(75.01) === 'старческий возраст'); //true
console.log(11, ageClassification(90) === 'старческий возраст'); //true
console.log(12, ageClassification(90.01) === 'долгожители'); //true
console.log(13, ageClassification(122) === 'долгожители'); //true
console.log(14, ageClassification(122.01) === null); //true
console.log(15, ageClassification(150) === null); //true
